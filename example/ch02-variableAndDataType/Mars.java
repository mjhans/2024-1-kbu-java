public class Mars{
    public static void main(String[] args){
        ...
        System.out.println(String.format("elapsed time(integer) : %d (sec)", nElapsedSeconds ));
        
        double dElapsedSeconds = earthToMarsDistances / radioSpeed;
        System.out.println(String.format("elapsed time(double) : %f (sec)", dElapsedSeconds ));
        ...
        System.out.println(String.format("elapsed time(integer) : %d (min)", nElapsedMinutes ));

        double dElapsedMinutes = dElapsedSeconds / MINUTES_TO_SECONDS;
        System.out.println(String.format("elapsed time(double) : %f (min)", dElapsedMinutes ));
    }
}